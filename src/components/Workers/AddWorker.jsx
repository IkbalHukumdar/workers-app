...
// + koymamızın sebebi String ifade ile başladığı için number olmasını istediğimiz için.
    ...
    <Card className="mt-10">
      <form className="flex flex-col gap-y-2" onSubmit={addWorkerHandler}>
        ...
        <input
          ...
          value={enteredWorkerName} //inputlara veri girdikten sonra boşaltmak için
        />
